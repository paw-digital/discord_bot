...
class StatsCog(commands.Cog):
    ...
    async def toptips_cmd(self, ctx: Context):
        ...
        embed.set_author(name='Biggest Tips', icon_url="https://github.com/bbedward/graham_discord_bot/raw/master/assets/banano_logo.png" if Env.banano() else ("https://github.com/paw_digital/discord_bot/raw/master/assets/paw_logo.png" if Env.paw() else "https://github.com/bbedward/graham_discord_bot/raw/master/assets/nano_logo.png"))
    ...
    async def leaderboard_cmd(self, ctx: Context):
        ...
        embed = discord.Embed(colour=0xFBDD11 if Env.banano() else (discord.Colour.dark_blue() if Env.paw() else discord.Colour.dark_blue()))
        embed.set_author(name=f"Here are the top {len(ballers)} tippers \U0001F44F", icon_url="https://github.com/bbedward/graham_discord_bot/raw/master/assets/banano_logo.png" if Env.banano() else ("https://github.com/paw_digital/discord_bot/raw/master/assets/paw_logo.png" if Env.paw() else "https://github.com/bbedward/graham_discord_bot/raw/master/assets/nano_logo.png"))
    ...
    async def legacyboard_cmd(self, ctx: Context):
        ...
        embed = discord.Embed(colour=0xFBDD11 if Env.banano() else (discord.Colour.dark_blue() if Env.paw() else discord.Colour.dark_blue()))
        embed.set_author(name=f"Here are the top {len(ballers)} tippers of all time\U0001F44F", icon_url="https://github.com/bbedward/graham_discord_bot/raw/master/assets/banano_logo.png" if Env.banano() else ("https://github.com/paw_digital/discord_bot/raw/master/assets/paw_logo.png" if Env.paw() else "https://github.com/bbedward/graham_discord_bot/raw/master/assets/nano_logo.png"))
        embed.description = response_msg
    ...
    async def blocks_cmd(self, ctx: Context):
        ...
        embed = discord.Embed(colour=0xFBDD11 if Env.banano() else (discord.Colour.dark_blue() if Env.paw() else discord.Colour.dark_blue()))
        embed.set_author(name=f"Here's how many blocks I have", icon_url="https://github.com/bbedward/graham_discord_bot/raw/master/assets/banano_logo.png" if Env.banano() else ("https://github.com/paw_digital/discord_bot/raw/master/assets/paw_logo.png" if Env.paw() else "https://github.com/bbedward/graham_discord_bot/raw/master/assets/nano_logo.png"))
